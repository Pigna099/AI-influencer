...
import { api, Character, CheckpointInfo, Conversation, GpuReport, Memory, Message, OllamaModel, CharacterProfile, RealismInput } from "../api";
      ...
      <aside className="character-rail">
        ...
        {character && <details className="realism-settings">
          ...
          <div className="ppv-settings">
            ...
            <label className="auto-label"><input type="checkbox" checked={!!character.activity_enabled} disabled={!!busy} onChange={e => saveRealism({ activity_enabled: e.target.checked })} /> {t("pg.activity")}</label>
