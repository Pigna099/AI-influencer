...
export class ApiClient {
  ...
  async queueTraining(loraId: string, data: {images_dir: string; base_checkpoint?: string; rank?: number; resolution?: number; steps?: number; learning_rate?: number; repeats?: number; batch_size?: number; caption_prefix?: string; save_every?: number; gpu?: number}): Promise<TrainingJob> {
