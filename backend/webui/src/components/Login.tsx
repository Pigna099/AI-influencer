      ...
      <div className="max-w-md w-full">
        <div className="bg-gray-900 rounded-xl p-8 shadow-2xl border border-gray-800">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-blue-400 mb-2">AI Influencer Playground</h1>
            <p className="text-gray-400">Character chat interface with Ollama integration</p>
          </div>
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>Your API key is stored in session storage and never saved.</p>
          </div>
        </div>
      </div>
    </div>
